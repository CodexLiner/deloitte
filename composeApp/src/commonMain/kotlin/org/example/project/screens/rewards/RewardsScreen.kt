...
import org.example.project.components.SimplePromoCard
...
fun RewardsScreen(
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            if (showQrCode) {
                // Main Screen Mode (Screenshot 3 & 4)
                item {
                ...
                // Promo Mode (Screenshot 1)
                item {
                    SimplePromoCard(
                        title = "Double Stack",
                        imageUrl = "https://s7d1.scene7.com/is/image/mcdonalds/t-mcdonalds-Double-Quarter-Pounder-with-Cheese-1:1-1-product-tile-desktop"
                    )
                }
                ...
                item {
                    SimplePromoCard(
                        ...
                        imageUrl = "https://s7d1.scene7.com/is/image/mcdonalds/mcdelivery_promo_yellow",
                        isYellow = true
                    )
                }
